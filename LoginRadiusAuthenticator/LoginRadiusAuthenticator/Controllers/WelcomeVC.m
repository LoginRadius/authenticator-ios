...
- (void)setInsetUI {
    ...
    if ([UIDevice currentDevice].userInterfaceIdiom == UIUserInterfaceIdiomPad)
    {
        ...
        if ([[code lowercaseString] containsString:@"iphone"])
{
        ...
        [_btnSecOption setImageEdgeInsets:UIEdgeInsetsMake(0, SCREEN_WIDTH* (-80)/ 320.0, 0, 0)];
           [_btnFirstOption setImageEdgeInsets:UIEdgeInsetsMake(0, SCREEN_WIDTH* (-140)/ 320.0, 0, 0)];
    }
    }
}
- (void)showViewToScan {
DYQRCodeDecoderViewController *vc = [[DYQRCodeDecoderViewController alloc] initWithCompletion:^(BOOL succeeded, NSString *result) {
               ...
               if (succeeded) {
                  ...
                  OTPURL *authURL = [OTPURL authURLWithURL:url
                                                            secret:nil];

...
+ (void)goToHome {
    LRURLSession *url = [[LRURLSession alloc] init];
    ...
    if(arr.count){
                                                                                       ...
                                                                                       frstVC = (UINavigationController*)[mainStoryboard instantiateViewControllerWithIdentifier:@"LRAuthListVCNav"];

        LRAuthListVC *listVC = (LRAuthListVC *)frstVC.viewControllers[0];
        listVC.authURLs = arr;
        listVC.isBack = false;
        
    }
    else {
        frstVC = (UINavigationController*)[mainStoryboard instantiateViewControllerWithIdentifier:@"LRWelcomeVCNav"];
    }

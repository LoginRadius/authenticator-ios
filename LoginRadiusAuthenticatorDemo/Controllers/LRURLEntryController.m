...
#import "LRURLEntryController.h"
#import <MobileCoreServices/MobileCoreServices.h>
#import "LRURL.h"
#import "HOTPGenerator.h"
#import "TOTPGenerator.h"

@interface LRURLEntryController ()
...
@implementation LRURLEntryController
...
- (IBAction)done:(id)sender {
  ...
  NSData *secret = [LRURL base64Decode:encodedSecret];
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
    LRAuthListVC *vc = (LRAuthListVC *)segue.destinationViewController;
    vc.authURLs = sender;
}
